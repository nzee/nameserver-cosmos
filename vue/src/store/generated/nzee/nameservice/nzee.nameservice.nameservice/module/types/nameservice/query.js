...
export const protobufPackage = "nzee.nameservice.nameservice";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("nzee.nameservice.nameservice.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Whois(request) {
        const data = QueryGetWhoisRequest.encode(request).finish();
        const promise = this.rpc.request("nzee.nameservice.nameservice.Query", "Whois", data);
    ...
    WhoisAll(request) {
        ...
        const promise = this.rpc.request("nzee.nameservice.nameservice.Query", "WhoisAll", data);
